...
class LearningModeCatalogTest {
	...
	fun modelMetadataMatchesPublishedArtifacts() {
		...
		assertMetadata(
			model = ModelType.SMALL_MULTILINGUAL_Q5_1,
	...
	fun userFacingModesUseDistinctSelectableModels() {
		...
		assertTrue(ModelType.BASE_MULTILINGUAL_Q5_1.userSelectable)
		assertTrue(ModelType.SMALL_MULTILINGUAL_Q5_1.userSelectable)
		assertTrue(ModelType.entries.filter(ModelType::userSelectable).all { it.expectedByteSize <= MAX_SELECTABLE_MODEL_BYTES })
	}
