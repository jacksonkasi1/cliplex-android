...
ClipLex is a private, on-device Android language-learning app that transforms permitted short media moments into replayable lessons, translated vocabulary, quizzes, speaking practice, and grounded tutoring.
...
6. Open **Practice** for quizzes, Speak & Match pronunciation, and lesson-grounded help.
...
3. Select English during onboarding and download **Whisper Tiny English (Q5_1)**. Model files are downloaded separately and integrity-checked.
...
5. Use a debug build for the known-good ASR diagnostic and benchmark UI.
6. Follow [`benchmarks/BENCHMARK.md`](benchmarks/BENCHMARK.md) to reproduce the Arm64 baseline-versus-optimized Whisper comparison.
...
ClipLex turns everyday watching into active learning: capture a meaningful moment, understand it immediately, retain its vocabulary, practise saying it, and revisit it through personalized exercises without sending private learning data to a server.
